...
TODO: Describe the frontend framework, build tooling, state library (if used), and why these choices were made for a local-network, low-latency application.

\subsubsection{Application Module Structure}
TODO: Explain how the frontend codebase is organized (pages, reusable components, services, socket client, statistics module, calibration module).
